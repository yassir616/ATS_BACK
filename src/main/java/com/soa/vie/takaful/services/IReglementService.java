...
public interface IReglementService {
	   ...
	   public Page<ReglementResponseDTO> getReglements(int page, int limit, String sort, String direction) throws InterruptedException, ExecutionException;
	   public List<ReglementResponseModel> modifierReglementPrestationByIdAndStatut(String id, String statut) throws InterruptedException, ExecutionException;
}
