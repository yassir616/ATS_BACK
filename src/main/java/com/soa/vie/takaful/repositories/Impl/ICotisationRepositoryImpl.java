...
public class ICotisationRepositoryImpl implements ICotisationRepositoryCustom{
	...
	public List<Cotisation> recupererEmissionGroupeParCriteres(EmissionGroupeRequestModel requestModel){
        ...
        log.info("Début d'execution de la requete getEmissionGlobale requestModel : {}",requestModel);
        ...
        addPredicates(requestModel, params, queryBuilder);
    ...
    private static void addPredicates(EmissionGroupeRequestModel requestModel, Map<String, Object> params, StringBuilder queryBuilder) {
